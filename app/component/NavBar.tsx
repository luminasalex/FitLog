        ...
        <nav className="w-full border-b border-[#2f3036] bg-[#090a0d]">
            <div className="mx-auto flex h-[70px] items-center justify-between px-5">
                ...
                <nav className="hidden items-center gap-2 md:flex">
                    ...
                    <Link href="/" className="rounded-full bg-[#182400] px-5 py-2 text-[12px] font-semibold text-[#baff00] transition hover:bg-[#233300]">
                        Workouts
                    </Link>

                    <Link href="/my-plan" className="rounded-full px-5 py-2 text-[12px] font-medium text-[#8b8d94] transition hover:text-white">
                        My Plan
                    </Link>
                ...
                <div className="hidden items-center gap-7 text-[12px] md:flex">
                    ...
                    {/* Plan */}
                    <Link href="/plan" className="flex items-center gap-2 text-[#a7a9b0] transition hover:text-white">
                        <span>Plan</span>
                    ...
                    <Link href="/saved" className="flex items-center gap-2 text-[#a7a9b0] transition hover:text-white">
                        <span>Saved</span>
                ...
                <div className="dropdown dropdown-end md:hidden">
                    ...
                    <ul tabIndex={0} className="menu dropdown-content z-[100] mt-3 w-48 rounded-xl border border-[#25262b] bg-[#0d0e11] p-2 shadow-2xl">
                        <li>
                            <Link href="/workouts" className="text-[#baff00]">
                                Workouts
                            </Link>
                        </li>
